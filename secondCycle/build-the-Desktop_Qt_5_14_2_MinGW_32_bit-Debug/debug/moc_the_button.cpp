/****************************************************************************
** Meta object code from reading C++ file 'the_button.h'
**
...
#include <memory>
#include "../../the/the_button.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'the_button.h' doesn't include <QObject>."
...
void TheButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TheButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (TheButton::*)(TheButtonInfo * );
...
QT_INIT_METAOBJECT const QMetaObject TheButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QPushButton::staticMetaObject>(),
    qt_meta_stringdata_TheButton.data,
    qt_meta_data_TheButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
